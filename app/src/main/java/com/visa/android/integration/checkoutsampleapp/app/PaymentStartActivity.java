...
public class PaymentStartActivity extends FragmentActivity implements VisaExpressCheckoutButton.CheckoutWithVisaListener {
    ...
    public void addTen(View view){
        TextView t2 = (TextView)findViewById(R.id.totalCost);
        String total = t2.getText().toString();
        Double result = Double.parseDouble(total)*1.1;
        t2.setText(Double.toString(result));
    }
    public void addFifteen(View view){
        TextView t2 = (TextView)findViewById(R.id.totalCost);
        String total = t2.getText().toString();
        Double result = Double.parseDouble(total)*1.15;
        t2.setText(Double.toString(result));
    }
